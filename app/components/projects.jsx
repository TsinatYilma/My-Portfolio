          ...
          <div className="section-header fade-anim ">
            <div className="section-title-wrapper ">
              <div className="subtitle-wrapper">
                <span className="section-subtitle text-lg sm:text-[1.5vw]">
                  Recent work
                </span>
              </div>
              <div className="title-wrapper text-[1.3vw]">
                <h2 className="section-title  text-start font-instRegular text-sm sm:text-[4vw] leading-none  w-full">
                  Creative works with awsome output.
                </h2>
              </div>
            </div>
          </div>
